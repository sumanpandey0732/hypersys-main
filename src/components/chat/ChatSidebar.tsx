...
export const AI_MODELS: AIModel[] = [
  ...
  { id: 'mistral-large-latest', name: 'Mistral Large Latest', label: 'Mistral Large', description: 'Fast flagship chat & vision (Default - Mistral API)', emoji: '🧬', kind: 'Chat', featured: true },
